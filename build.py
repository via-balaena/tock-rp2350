...
INTENT = {
    ...
    "tock:rp2-adc": ("upstream", "Moves the SAR ADC driver into the shared rp2xxx crate and adds the RP2350's. Two commits, the same shape as #5112, which merged.", "Ready. Unblocks the whole analogue tier of the breadboard kit — joystick, potentiometer, light sensor, thermistor — none of which needs new wiring."),
...
FACTS = {
    "tock:rp2350-gpio-irq": [
        ...
        ("Evidence", "Observed on hardware with two buttons on GPIO 14 and 15. The application read both resting levels successfully through the same driver, then asked for an edge interrupt, and the kernel panicked before the call returned — so it cannot be read as a malformed request. The panic names the syscall: driver 4, subdriver 7, arg0 14."),
    ],
    "tock:rp2-adc": [
        ...
        ("Not verified", "No board instantiates it yet and no analogue input has been read. It builds, fmt and clippy are clean."),
    ],
