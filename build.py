...
FACTS = {
    ...
    "libtock-rs:unittest-fakes": [
        ...
        ("Provenance", "Cherry-picked from the async branch, where they were written. Verified there as bbee667 and b31b015, touching `unittest/src/fake/alarm/` and `unittest/src/fake/console/` only."),
    ],
    "libtock-rs:platform-pico2": [
        ...
        ("Where the addresses came from", "Read off a linked kernel with nm rather than off the linker script, because the application region is what the kernel leaves rather than what the board reserves: _sapps 0x10040000, _eapps 0x10080000. Applications built through this row load, run and print on real hardware."),
