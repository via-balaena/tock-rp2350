...
FACTS = {
    ...
    "tock:stepper-capsule": [
        ...
        ("Not verified", "**Nothing has run.** No board instantiates it, no motor has turned, there is no component and no test. It builds, it is formatted, clippy is clean including nursery lints, and it is internally consistent. That is the whole of the claim."),
    ],
    "libtock-rs:stepper": [
        ...
        ("Not verified", "**Nothing has run.** The example is ready to drive the capsule the moment a board instantiates it."),
    ],
