...
FACTS = {
    ...
    "tock:stepper-capsule": [
        ...
        ("Verified on silicon", "The motor turns 4096 steps each way, first flash. The safety property is demonstrated rather than argued: reading the GPIO output register over the debug port shows windings 20 and 21 energised mid-run — exactly one row of the half-step table, which cross-checks the sequence logic — then `terminate` on the process console, then all four windings clear, with the kernel still answering afterwards so that \"stopped\" is not \"dead kernel\"."),
    ...
    "libtock-rs:stepper": [
        ...
        ("Verified on silicon", "Drove the capsule on a Pico 2 W: 4096 steps forward, 4096 reverse, first flash."),
    ],
